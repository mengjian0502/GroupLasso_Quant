...
def main():
    ...
    model_cfg.kwargs.update({"num_classes": num_classes, "wbit": args.wbit, "abit":args.abit, "alpha_init": args.alpha_init, "mode": args.q_mode, "k": args.k, "col_size": args.col_size, "ch_group":args.group_ch, "ADCprecision":args.adc_prec, "cellBit":args.cellBit})
    ...
    # Evaluate
    if args.evaluate:
        # load activation clipping parameter
        alpha = []
